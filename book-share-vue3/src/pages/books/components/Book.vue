...
import { Book } from "~/middleware/trpc";
      ...
      <div v-if="book.volumeInfo" class="flex flex-col gap-1 text-gray-900">
        ...
        <footer class="flex flex-wrap items-start justify-start gap-2">
          <a
            ...
            target="_blank"
            class="flex w-[140px] items-center justify-center rounded-md border bg-white px-2 py-2 text-center text-sm font-medium capitalize text-blue-500 transition-colors hover:text-blue-900 hover:underline"
            @click.stop
          >
          ...
          <a
            ...
            target="_blank"
            class="flex w-[140px] items-center justify-center rounded-md border bg-white px-2 py-2 text-center text-sm font-medium text-blue-500 transition-colors hover:text-blue-900 hover:underline"
            @click.stop
          >
