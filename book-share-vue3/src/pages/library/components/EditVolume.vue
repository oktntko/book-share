...
import { Book, trpc, VolumeInput } from "~/middleware/trpc";
    ...
    <form class="flex flex-col gap-4" @submit.prevent="handleSubmit">
      ...
      <div v-show="book" class="relative">
        ...
        <div class="absolute right-4 top-4">
          <div class="flex gap-4">
            ...
            >
              <Icon icon="flat-color-icons:search" class="-ml-1 mr-2 h-5 w-5"></Icon>
              <p>本を探す</p>
            </button>
            <button
              type="button"
      ...
      <footer class="flex justify-start gap-4">
        ...
        <button
          ...
          @click="handleDelete"
        >
          <Icon icon="fa6-solid:trash" class="-ml-1 mr-2 h-5 w-5"> </Icon>
          寄贈を取り消す
        </button>
      </footer>
    </form>
