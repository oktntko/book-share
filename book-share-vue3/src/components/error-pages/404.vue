...
<template>
  <section
    class="flex h-full items-center dark:bg-gray-900 dark:text-gray-100 sm:p-16"
  >
    <div
    ...
    >
      ...
      <RouterLink
        ...
        to="/"
        class="rounded bg-blue-100 px-8 py-3 transition-colors hover:bg-blue-500 hover:text-white"
      >
        ホームに戻る
      </RouterLink>
    </div>
