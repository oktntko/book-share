...
import { nextTick, onBeforeUnmount, onMounted, ref, withDefaults } from "vue";
...
const refConfirmButton = ref<InstanceType<typeof Button> | null>(null);
const refCancelButton = ref<InstanceType<typeof Button> | null>(null);
...
<template>
  <div class="relative z-10" role="dialog" aria-modal="true">
    ...
    >
      <div v-show="open" class="fixed inset-0 bg-gray-400/50 transition-opacity" />
    </Transition>
