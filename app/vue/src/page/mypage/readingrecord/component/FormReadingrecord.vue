    ...
    <section class="flex flex-col gap-4">
      ...
      <div>
        ...
        <input
          ...
          maxlength="400"
        />
        <ErrorMessage field="book_title" class="text-xs text-red-600" />
      </div>
      <!-- 読んだ日 -->
      <div>
        ...
        <input
          ...
          required
        />
        <ErrorMessage field="read_date" class="text-xs text-red-600" />
      </div>
      <!-- 評価 -->
      ...
      <div>
        ...
        <ErrorMessage field="star" class="text-xs text-red-600" />
      </div>
      <!-- ひとこと -->
      <div>
        ...
        <input
          ...
          maxlength="255"
        />
        <ErrorMessage field="hitokoto" class="text-xs text-red-600" />
      </div>
    </section>
