  ...
  >
    ...
    <div class="flex justify-between">
      <div class="flex items-center gap-1">
        <Icon icon="mdi:read" class="text-green-800"></Icon>{{ readingrecord.read_date }}
      </div>
      <div class="relative inline-block text-left">
        ...
        >
          <div
            v-show="showMenu"
            class="absolute right-0 z-50 mt-2 w-32 origin-top-right divide-y divide-gray-100 rounded-md bg-white text-gray-700 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
            tabindex="-1"
          >
            <a
